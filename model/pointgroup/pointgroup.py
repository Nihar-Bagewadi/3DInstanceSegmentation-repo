...
class pointnet2(nn.Module):
    def __init__(self,input_c):
        ...
        self.sa1 = PointNetSetAbstraction(1024, 0.1, 32, input_c + 3, [32, 32, 64], False)
...
class PointGroup(nn.Module):
    def __init__(self, cfg):
        ...
        #### backbone
        self.pointnet2 = pointnet2(input_c)
    ...
    def forward(self, input, input_map, coords, batch_idxs, batch_offsets, epoch,feats):
        '''
